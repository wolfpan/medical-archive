...
- findings: 报告正文原文转录（重要，尽量完整）：先一行患者信息（性别、年龄、门诊号/检查号/住院号等），再逐段转录"超声所见/影像所见/检验结果/检查结果"等正文，保留原文表述、数值与单位，不要改写、概括或省略数据
...
如果某页是封面、导检单、须知或广告等无医疗价值内容，注明"（无有效内容）"即可。不要编造未出现的信息。`;
