...
const APP_VERSION = '0.15'; // 功能迭代每次推送 +0.1，与页脚展示一致
...
- title: 简明标题，只写检查/就诊项目本身，不要包含医院或机构名称（医院有单独字段），例如"乳腺超声检查"（必填）
...
- title: 简明标题，只写检查/就诊项目本身，不要包含医院或机构名称（医院有单独字段），多资料合并时概括为主要检查（必填）
